...
// Type: Ktisis.Actions.Handlers.Camera.CameraOffsetToTargetModelAction
...
[Action("Camera_SetOffset_Model")]
public class CameraOffsetToTargetModelAction(IPluginContext ctx) : KeyAction(ctx) {
