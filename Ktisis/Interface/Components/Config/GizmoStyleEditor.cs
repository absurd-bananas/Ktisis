...
public class GizmoStyleEditor
{
  ...
  public void Draw()
  {
    ...
    Style style = this.Config.Gizmo.Style;
    using (ImRaii.Child(ImU8String.op_Implicit("##CfgStyleFrame"), Dalamud.Bindings.ImGui.ImGui.GetContentRegionAvail(), true))
    {
      ...
      {
        GizmoStyleEditor.DrawStyleFloat("Gizmo Scale##posGizmoScale", ref this.Config.Gizmo.PositionGizmoScale, 0.1f, 0.05f, 0.5f);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.position.line_thick") + "##PosThickness", ref style.TranslationLineThickness, defaultStyle.TranslationLineThickness);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.position.arrow_size") + "##PosArrowSize", ref style.TranslationLineArrowSize, defaultStyle.TranslationLineArrowSize);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.position.axis_thick"), ref style.HatchedAxisLineThickness, defaultStyle.HatchedAxisLineThickness);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.position.circle_size") + "##PosCircleSize", ref style.CenterCircleSize, defaultStyle.CenterCircleSize);
      ...
      {
        GizmoStyleEditor.DrawStyleFloat("Gizmo Scale##rotGizmoScale", ref this.Config.Gizmo.RotationGizmoScale, 0.1f, 0.05f, 0.5f);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.rotation.inner_thick") + "##RotateThickness", ref style.RotationLineThickness, defaultStyle.RotationLineThickness);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.rotation.outer_thick") + "##RotateThicknessOuter", ref style.RotationOuterLineThickness, defaultStyle.RotationOuterLineThickness);
      ...
      {
        GizmoStyleEditor.DrawStyleFloat("Gizmo Scale##scaGizmoScale", ref this.Config.Gizmo.ScaleGizmoScale, 0.1f, 0.05f, 0.5f);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.scale.line_thick") + "##ScaleThickness", ref style.ScaleLineThickness, defaultStyle.ScaleLineThickness);
        GizmoStyleEditor.DrawStyleFloat(this._locale.Translate("config.gizmo.editor.scale.circle_size") + "##ScaleSize", ref style.ScaleLineCircleSize, defaultStyle.ScaleLineCircleSize);
    ...
    float maxValue = -1f)
  {
    ...
    using (ImRaii.PushId(imU8String, true))
    {
      ...
      Dalamud.Bindings.ImGui.ImGui.SameLine(0.0f, ((ImGuiStylePtr) ref style).ItemInnerSpacing.X);
      Dalamud.Bindings.ImGui.ImGui.SetNextItemWidth(Dalamud.Bindings.ImGui.ImGui.CalcItemWidth() - (Dalamud.Bindings.ImGui.ImGui.GetCursorPosX() - cursorPosX));
      if ((double) minValue == -1.0 && (double) maxValue == -1.0)
