...
public class LightingEditor : EditorBase
{
  ...
  public override bool IsActivated(EnvOverride flags) => flags.HasFlag((Enum) EnvOverride.Lighting);
  ...
  public override void Draw(IEnvModule module, ref EnvState state)
  {
    ...
    {
      using (ImRaii.Disabled(!module.Override.HasFlag((Enum) EnvOverride.Lighting)))
      {
