...
public static Dictionary<EntityType, EntityDisplay> GetDefaults() => new Dictionary<EntityType, EntityDisplay> {
	{
		EntityType.Invalid,
		new EntityDisplay()
	}, {
...
public override int GetHashCode() =>
	((EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<uint>.Default.GetHashCode(this.Color)) * -1521134295 + EqualityComparer<FontAwesomeIcon>.Default.GetHashCode(this.Icon)) * -1521134295 +
	EqualityComparer<DisplayMode>.Default.GetHashCode(this.Mode);
[CompilerGenerated]
public virtual bool Equals(EntityDisplay? other) {
	if ((object)this == (object)other)
		return true;
	return (object)other != null && this.EqualityContract == other.EqualityContract && EqualityComparer<uint>.Default.Equals(this.Color, other.Color) && EqualityComparer<FontAwesomeIcon>.Default.Equals(this.Icon, other.Icon) &&
		EqualityComparer<DisplayMode>.Default.Equals(this.Mode, other.Mode);
}
[CompilerGenerated]
