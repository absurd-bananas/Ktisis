...
public record McdfHeader()
{
  ...
  public override int GetHashCode()
  {
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    return ((EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<byte>.Default.GetHashCode(this.\u003CVersion\u003Ek__BackingField)) * -1521134295 + EqualityComparer<string>.Default.GetHashCode(this.\u003CFilePath\u003Ek__BackingField)) * -1521134295 + EqualityComparer<McdfData>.Default.GetHashCode(this.\u003CData\u003Ek__BackingField);
  }
  ...
  public virtual bool Equals(McdfHeader? other)
  {
    ...
    // ISSUE: reference to a compiler-generated field
    // ISSUE: reference to a compiler-generated field
    return (object) other != null && this.EqualityContract == other.EqualityContract && EqualityComparer<byte>.Default.Equals(this.\u003CVersion\u003Ek__BackingField, other.\u003CVersion\u003Ek__BackingField) && EqualityComparer<string>.Default.Equals(this.\u003CFilePath\u003Ek__BackingField, other.\u003CFilePath\u003Ek__BackingField) && EqualityComparer<McdfData>.Default.Equals(this.\u003CData\u003Ek__BackingField, other.\u003CData\u003Ek__BackingField);
  }
