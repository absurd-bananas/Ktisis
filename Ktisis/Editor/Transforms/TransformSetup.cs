...
public override int GetHashCode() {
	return ((EqualityComparer<Type>.Default.GetHashCode(this.EqualityContract) * -1521134295 + EqualityComparer<bool>.Default.GetHashCode(this.MirrorRotation)) * -1521134295 + EqualityComparer<bool>.Default.GetHashCode(this.ParentBones)) *
		-1521134295 + EqualityComparer<bool>.Default.GetHashCode(this.RelativeBones);
}
...
public virtual bool Equals(TransformSetup? other) {
	if ((object)this == (object)other)
		return true;
	return (object)other != null && this.EqualityContract == other.EqualityContract && EqualityComparer<bool>.Default.Equals(this.MirrorRotation, other.MirrorRotation) && EqualityComparer<bool>.Default.Equals(this.ParentBones, other.ParentBones) &&
		EqualityComparer<bool>.Default.Equals(this.RelativeBones, other.RelativeBones);
}
