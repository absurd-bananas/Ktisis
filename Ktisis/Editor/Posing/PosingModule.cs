...
public sealed class PosingModule : HookModule {
	...
	private IntPtr CalcBoneModelSpace(ref hkaPose pose, int boneIdx) => this.Manager.IsSolvingIk ? this._calcBoneModelSpaceHook.Original(ref pose, boneIdx) : (IntPtr)(pose.ModelPose.Data + boneIdx);

	private IntPtr LookAtIK(IntPtr a1, IntPtr a2, IntPtr a3, float a4, IntPtr a5, IntPtr a6) => IntPtr.Zero;
	...
	private unsafe void HandleRestoreState(Skeleton* skeleton, ushort partialId) {
		...
		var onSkeletonInit = this.OnSkeletonInit;
